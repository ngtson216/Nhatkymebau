...
export default function DiseasesNeedVaccin() {
    ...
    return (
        <div>
            <div className={styleTable.title}>
                <b>Bệnh cần tiêm chủng cho trẻ</b>
            </div>
            <input className={QLBCTC.searchBarUser} type='text' placeholder='Nhập tên bệnh..' onChange={(event) => {
