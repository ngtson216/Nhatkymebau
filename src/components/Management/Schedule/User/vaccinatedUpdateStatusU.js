...
function CancelStatus(IDSche, cancel) {
    const url = 'http://103.74.123.192:8080/api/schedulevaccinated/' + cancel + '/' + IDSche
...
export default function VaccinatedStatusUser(props) {
    ...
    return (
        <div>
            ...
            <div style={{ textAlign: 'left' }}>
                <ul>
                    <li>
                        Thời gian khám: {props.dataFromParent[0].time}
                    </li>
                    <li>
