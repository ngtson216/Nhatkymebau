...
import StatusCSYT from './medicalUpdateStatus';
export default function MedicalScheduleCSYT() {
    ...
    const url = "http://nhatkymebau.vn:8080/api/schedule/list"
    useEffect(() => {
    ...
    return (
        <div>
            <div className={styleTable.title}>
                <b>Quản lý danh sách lịch khám </b>
            </div>
            ...
            <table className={`${QLBCTC.tableStyle}`} style={{ marginTop: '50px' }}>
                <thead>
                    <tr style={{ background: '#aee8ff' }}>
                        ...
                        <th style={{ width: '20%' }}>Kiểu khám</th>
                        ...
                        items.filter((item) => {
                            ...
                            return (
                                <tr key={index}>
                                    ...
                                    <td className={QLBCTC.center}>
                                        <Link to="/medicalScheduleManagement"
                                            onClick={() => {
                                        ...
                                        <Popup trigger={buttonPopup} setTrigger={setButtonPopup} >
                                            < StatusCSYT dataFromParent={getId} />
                                        </Popup>
                                    </td>
                                </tr>
                            )
