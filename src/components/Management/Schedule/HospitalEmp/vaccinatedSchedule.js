...
import VaccinatedStatusHos from './vaccinatedUpdateStatus';
import styleTable from '../../../../CSS/TableStyle.module.scss'
export default function VaccinatedScheCSYT() {
    ...
    const url = "http://nhatkymebau.vn:8080/api/schedulevaccinated/list/"
    useEffect(() => {
    ...
    return (
        <div>
            <div className={styleTable.title}>
                <b>Quản lý danh sách lịch tiêm</b>
            </div>
            ...
            <table className={`${QLBCTC.tableStyle}`} style={{ marginTop: '50px' }}>
                <thead>
                    <tr style={{ background: '#aee8ff' }}>
                        ...
                        <th style={{ width: '20%' }}>Tên của trẻ</th>
                        <th style={{ width: '20%' }}>Tên của mẹ</th>
                        ...
                        items.filter((item) => {
                            ...
                            return (
                                <tr key={index}>
                                    ...
                                    <td className={QLBCTC.center}>
                                        <Link to="/vaccinatedScheduleManagement"
                                            onClick={() => {
                                        ...
                                        <Popup trigger={buttonPopup} setTrigger={setButtonPopup} >
                                            < VaccinatedStatusHos dataFromParent={getId} />
                                        </Popup>
                                    </td>
                                </tr>
                            )
